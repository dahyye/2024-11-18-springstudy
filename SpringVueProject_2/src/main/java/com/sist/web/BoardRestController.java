...
public class BoardRestController {
  ...
  public ResponseEntity<Map> board_list_vue(@PathVariable("page") int page)
  {
  ...
  public ResponseEntity<Map> board_detail_vue(@PathVariable("no") int no)
  {
	  Map map = new HashedMap();
	  try {
		  BoardVO vo = dao.boardDetailData(no);
		  dao.boardHitIncrement(no);
		  map.put("vo", vo);
		  map.put("msg", "yes");
	  }catch(Exception ex)
	   {
  ...
  public ResponseEntity<Map> board_delete_vue(@PathVariable("no") int no, @PathVariable("pwd") String pwd)
  {
	  Map map=new HashMap();
	  try {
