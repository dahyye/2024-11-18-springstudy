	  ...
	  data(){
		  return {
			  sawon:[
				  ...
				  {"sabun":2, "name":"심청이","sex":"여자","dept":"영업부","loc":"경기"},
				  {"sabun":3, "name":"박문수","sex":"남자","dept":"총무부","loc":"대구"},
				  {"sabun":4, "name":"이순신","sex":"남자","dept":"자재부","loc":"인천"},
				  {"sabun":5, "name":"강감찬","sex":"남자","dept":"기획부","loc":"부산"}
			  ],
			  isShow:false,
			  detail_data:{}
		  }
