<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%--
	1. 생성 : 여러개 생성이 가능하다 => 상세보기 , 댓글 -> 재사용 (.JS)
			 ---
			 범위 지정 -> Vue에서 제어
			 .mount("태그명(id->#, class->.")
			 ------ 가상메모리에 올리는 상태
			...
			axios.get(서버url,{
				...
				params:{
					...
					page:1
							...
							스프링프레임워크에서는 null값을 줘서 3번째 매개변수로 넣어줘야 가능
							스프링부트에서는 null없이 사용가능
			axois.post(서버url,null,{
				서버에 요청값 전송
		...
		=> 결과값 받기
			...
			}).then(res=>{		.then이 실행결과값 받는 부분 => res안에 값이 저장
	...
	6. 출력 / 이벤트 등록
	   출력 - HTML안에서 처리
		  ...
		  초기값   초기값출력   이벤트처리	  처리결과  갱신된 값 전송
		  Model => View => ViewModel => Model => View (양방향통신)
